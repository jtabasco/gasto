...
<body>
 	...
 	<div class="row mt-5 ms-3 me-3">
      <div class="col-sm-3 p-1 fw-bold">
      	¡Hola,  <?php echo $_SESSION['user'] ?>! <button type="button" class="btn btn-success f-strong" data-bs-toggle="modal" data-bs-target="#aGasto" id="addAceptar">+</button><button type="button" class="btn btn-info f-strong ms-3" data-bs-toggle="modal" data-bs-target="#verreporte" id="reporte">Reporte</button>
      </div>
...
<div class="modal shadow" id="verreporte" tabindex="-1" aria-labelledby="averreporte" aria-hidden="true">
  <div class="modal-mb modal-dialog modal-dialog-centered modal-dialog-scrollable" >
    <div class="modal-content">
     ...
     <!-- Entrada de gasto -->
<div class="modal shadow" id="aGasto" tabindex="-1" aria-labelledby="aGasto" aria-hidden="true">
  <div class="modal-mb modal-dialog modal-dialog-centered modal-dialog-scrollable" >
    <div class="modal-content">
...
$(document).ready(function(){
		$('#aGasto').modal({backdrop:'static'}); //para que no se cierre con click fuera
