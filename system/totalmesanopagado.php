...
$sql = "SELECT sum(monto) as importe FROM detalle_gasto where pagado='Si' and deudor='".$_SESSION['idUser']."' and month(fecha)='$mes' and year(fecha)='$ano' GROUP by year(fecha),month(fecha); ";
// Ejeuctar el SQL
