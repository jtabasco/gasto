...
$sql = "SELECT deudas_comprador_deudor.*, usuarios.id FROM `deudas_comprador_deudor` inner join usuarios on deudas_comprador_deudor.duedor=usuarios.nombre where comprador='".$_SESSION['user']."'";
// Ejeuctar el SQL
...
while($data = $query->fetch_object()){
	...
	//ok
 $data_array[] = array($data->duedor,$data->total,$data->id); 
